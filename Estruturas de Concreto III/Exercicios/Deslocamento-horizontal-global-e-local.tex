...
Calcula-se $F_{d, minorada}$ pela equação: $$F_{d, minorada}=1,4\cdot\psi_0\cdot H_v$$
...
O valor de deslocamento local de cada pavimento deve ser obtido da seguinte forma: $${\Delta_{desloc, 2}}_i={(d_{horiz}\cdot\psi_1)}_i-{(d_{horiz}\cdot\psi_1)}_{i-1}$$
